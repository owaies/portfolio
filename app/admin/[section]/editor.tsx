...
// Records from different admin tables intentionally have different nullable fields.
// Keep the editor's generic record shape separate from the strongly typed Project model.
