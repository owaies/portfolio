...
import { Check, Eye, Sparkles, X, Upload, Image as ImageIcon, Camera, Trash2 } from 'lucide-react'
...
function ProfileImageManager({ initialImages }: { initialImages: Record<UIExperienceId, string> }) {
  ...
  return <section className="ui-profile-manager" aria-labelledby="ui-profile-title" style={{ display: 'block', marginBottom: '2rem' }}>
    <div className="ui-profile-manager-heading">
      ...
      <div className="ui-profile-manager-note"><Camera size={16}/> <span>4 independent profile pictures</span></div>
    </div>
