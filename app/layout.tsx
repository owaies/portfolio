...
import "./ui-experience-confirm.css"
import "./ui-experience-fixes.css"
import "./desktop-mode-fix.css"
import "./experience-loading.css"
import "./obsidian-forge.css"
import "./obsidian-forge-reference.css"
import SiteNav from "./site-nav-v2"
import PremiumUX from "./premium-ux"
import UIExperienceRuntime from "./ui-experience-runtime"
import ExperienceLoadingScreen from "./experience-loading"
...
export default async function RootLayout({children}:{children:React.ReactNode}){const supabase=await createClient();const {data}=await supabase.from('site_content').select('value').eq('key','active_ui_experience').maybeSingle();const active=isUIExperienceId(data?.value)?data.value:DEFAULT_UI_EXPERIENCE;return <html lang="en"><head><link rel="stylesheet" href="/ui-experience-fixes.css"/><link rel="stylesheet" href="/desktop-site-layout-fix.css"/><link rel="stylesheet" href="/organic-intelligence.css?v=2"/><link rel="stylesheet" href="/neural-interface.css?v=1"/><link rel="stylesheet" href="/digital-architecture.css?v=1"/><link rel="stylesheet" href="/digital-architecture-polish.css?v=1"/><link rel="stylesheet" href="/mobile-experience-polish.css?v=1"/><link rel="stylesheet" href="/touch-desktop-polish.css?v=1"/><link rel="stylesheet" href="/obsidian-forge-responsive-art-direction.css?v=1"/><link rel="stylesheet" href="/education-language-resume-fixes.css?v=3"/><link rel="stylesheet" href="/obsidian-forge-title-overlap-fix.css?v=1"/><link rel="stylesheet" href="/mobile-project-grid-fix.css?v=1"/><link rel="stylesheet" href="/obsidian-forge-certificates.css?v=1"/></head><body data-ui-experience={active}><UIExperienceRuntime active={active}/><ExperienceLoadingScreen/><SiteNav/><PremiumUX>{children}</PremiumUX><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(structuredData)}}/></body></html>}