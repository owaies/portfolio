...
body[data-ui-experience="obsidian-forge"] .forge-cinematic-video{position:absolute;inset:0;z-index:0;width:100%;height:100%;display:block;visibility:visible;object-fit:cover;object-position:center center;opacity:1!important;filter:saturate(.88) contrast(1.04) brightness(.96);transform:translateZ(0)}
...
body[data-ui-experience="obsidian-forge"] .target-grid{z-index:1!important}
...
body[data-ui-experience="obsidian-forge"] .forge-cinematic-video{object-position:60% center;opacity:1!important;filter:saturate(.86) contrast(1.04) brightness(.92)}
