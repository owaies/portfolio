...
body[data-ui-experience="obsidian-forge"] .forge-cinematic-grade{z-index:1;background:linear-gradient(90deg,rgba(3,4,5,.74) 0%,rgba(3,4,5,.42) 34%,rgba(3,4,5,.08) 62%,rgba(3,4,5,.28) 100%),linear-gradient(180deg,rgba(2,3,4,.36),transparent 34%,rgba(2,3,4,.76) 100%)}
...
body[data-ui-experience="obsidian-forge"] .forge-cinematic-copy-veil{position:absolute;inset:14% auto 8% 0;width:min(58%,760px);z-index:8;pointer-events:none;background:linear-gradient(90deg,rgba(3,4,5,.48),rgba(3,4,5,.14) 68%,transparent)}
body[data-ui-experience="obsidian-forge"] .target-hero-inner{z-index:12!important}
body[data-ui-experience="obsidian-forge"] .target-hero .target-portrait-wrap{display:none!important}
...
body[data-ui-experience="obsidian-forge"] .forge-cinematic-video{object-position:62% center;opacity:.92;filter:saturate(.7) contrast(1.08) brightness(.68)}
body[data-ui-experience="obsidian-forge"] .forge-cinematic-portrait{left:61%;bottom:-4%;width:min(94vw,620px);height:min(79dvh,700px);transform:translateX(-48%);filter:contrast(1.08) brightness(.85) saturate(.82) drop-shadow(9px 3px 15px rgba(255,145,72,.13))}
body[data-ui-experience="obsidian-forge"] .forge-cinematic-rim{left:61%;bottom:0;width:min(94vw,620px);height:min(79dvh,700px);transform:translateX(-48%)}
body[data-ui-experience="obsidian-forge"] .forge-cinematic-copy-veil{inset:16% auto 12% 0;width:88%;background:linear-gradient(90deg,rgba(3,4,5,.68),rgba(3,4,5,.28) 64%,transparent)}
}
...
export default function ObsidianForgeCinematicHero(){
  ...
  return <>
    ...
    <div className="forge-cinematic-hero" aria-hidden="true">
      <video ref={videoRef} className="forge-cinematic-video" autoPlay muted playsInline loop preload="metadata" poster="/obsidian-forge-environment.svg">
      ...
      <div className="forge-cinematic-haze"/>
