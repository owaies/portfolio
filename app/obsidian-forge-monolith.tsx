...
body[data-ui-experience="obsidian-forge"] .target-hero::before {
  z-index:10!important; opacity:.22;
}
body[data-ui-experience="obsidian-forge"] .target-hero::after {
  z-index:11!important;
}
body[data-ui-experience="obsidian-forge"] .target-hero-inner {
  z-index:12!important;
}
body[data-ui-experience="obsidian-forge"] .target-portrait-wrap {
...
body[data-ui-experience="obsidian-forge"] .target-hero-description {
...
@media (prefers-reduced-motion:reduce) {
  body[data-ui-experience="obsidian-forge"] .forge-cinematic-video { animation:none; }
}
`

type Props={portraitSrc:string}

export default function ObsidianForgeMonolith({portraitSrc}:Props){
