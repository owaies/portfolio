...
import { ArrowDown, ArrowUpRight, Award, BriefcaseBusiness, Code2, Cpu, Download, ExternalLink, GraduationCap, Mail, MessageCircle } from 'lucide-react'
    ...
    <section id="home" className="container relative flex min-h-[calc(100vh-70px)] items-center py-16 lg:py-20">
      <div className="grid w-full items-center gap-16 lg:grid-cols-[1.05fr_.95fr]">
        <div>
          ...
          <div className="mt-10 grid max-w-xl grid-cols-3 gap-6 border-t border-white/[.07] pt-6"><Stat n={c.hero_projects_count} label="Projects deployed"/><Stat n={c.hero_cgpa} label="Current CGPA"/><Stat n={c.hero_certs_count} label="Certifications"/></div>
        </div>
        <div className="float flex justify-center lg:justify-end"><div className="hero-image-ring"><div className="hero-image flex h-64 w-64 items-center justify-center overflow-hidden bg-black/70 sm:h-[400px] sm:w-[400px]"><img src={image} alt="Mohammed Owaies" className="hero-image h-full w-full"/></div></div></div>
      </div>
