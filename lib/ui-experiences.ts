export type UIExperienceId = 'digital-architecture' | 'organic-intelligence' | 'neural-interface'
...
export const UI_EXPERIENCES: Record<UIExperienceId, UIExperience> = {
  'digital-architecture': {
    ...
    keywords: ['Light', 'Futuristic', 'Scientific'],
    accent: '#1677ff',
  },
  'organic-intelligence': {
    ...
    keywords: ['Nature', 'Technology', 'Organic'],
    accent: '#168b57',
  },
  'neural-interface': {
    id: 'neural-interface',
    ...
    keywords: ['Dark', 'Futuristic', 'Technical'],
    accent: '#35e6ff',
  },
}

export function isUIExperienceId(value: string | null | undefined): value is UIExperienceId {
  return value === 'digital-architecture' || value === 'organic-intelligence' || value === 'neural-interface'
}
